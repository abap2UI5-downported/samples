...
CLASS Z2UI5_CL_DEMO_APP_258 IMPLEMENTATION.
  ...
  METHOD RENDER_MAIN_VIEW.
    ...
    content = page->flex_box( width = '100%' height = '90%' alignitems = 'Start' ).

    
    navlist = content->flex_box( width = '100%' height = '100%' direction = 'Column' )->layout_data( )->flex_item_data( growfactor = '1'
    ...
    site_content = content->flex_box( id = 'site_content' class = 'sapUiTinyMarginTop sapUiTinyMarginBegin' width = '100%' height = '100%' backgrounddesign = 'Solid'
