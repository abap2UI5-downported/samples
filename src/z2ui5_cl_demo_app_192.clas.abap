...
CLASS z2ui5_cl_demo_app_192 IMPLEMENTATION.
  ...
  METHOD get_data.
    ...
    FIELD-SYMBOLS <fs_s_head_new> TYPE any.
      FIELD-SYMBOLS <fs_s_new_data> LIKE LINE OF mt_new_data.
    CLEAR temp1.
    ...
    LOOP AT kopf->* ASSIGNING <fs_s_head>.
      ...
      APPEND INITIAL LINE TO mt_new_data ASSIGNING <fs_s_new_data>.
      ...
      MOVE-CORRESPONDING <fs_s_head_new> TO <fs_s_head>.
