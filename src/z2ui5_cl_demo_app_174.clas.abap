CLASS z2ui5_cl_demo_app_174 DEFINITION PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    DATA ms_layout  TYPE z2ui5_cl_pop_layout=>ty_s_layout.
...
ms_layout = z2ui5_cl_pop_layout=>init_layout(
      tab       = temp6
  ...
  METHOD on_after_layout.
        DATA temp7 TYPE REF TO z2ui5_cl_pop_layout.
        DATA app LIKE temp7.
        DATA ls_result TYPE z2ui5_cl_pop_layout=>ty_s_result.
  ...
  METHOD on_event_layout.
    ...
    CASE client->get( )-event.
      ...
      WHEN 'LAYOUT_EDIT'.
        client->nav_app_call( z2ui5_cl_pop_layout=>factory( layout = ms_layout
